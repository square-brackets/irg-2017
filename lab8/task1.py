...
# eps = int(raw_input('Molim epsilon vrijednost: '))
# m = int(raw_input('Molim maksimalan broj iteracija: '))
# umin = float(raw_input('Molim umin: '))
# umax = float(raw_input('Molim umax: '))
# vmin = float(raw_input('Molim vmin: '))
# vmax = float(raw_input('Molim vmax: '))
